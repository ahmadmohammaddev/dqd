...
@section('admin')
    <h1 style="-: 0px">إضافة اكثر من خلية</h1>
    <form id="one_cell_form" method="POST" action="{{ route('quran.post_multi_cells') }}">
        @csrf
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="date" name="recitting_date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" class="form-control"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#page_number_1').append(`<option value="0" disabled selected>  يرجى اختيار اسم السورة أولاَ</option>`);
                ...
                $('#page_number_2').append(`<option value="0" disabled selected>  يرجى اختيار اسم السورة أولاَ</option>`);
